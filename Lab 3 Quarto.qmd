...
data_path <- "./stroop.csv" #This is a variable data path command. It means that as long as this Qmd file is located in the same directory as the data file, you don't need to specify the working directory.
stroop_data <- read.csv(data_path, header = TRUE)
```
